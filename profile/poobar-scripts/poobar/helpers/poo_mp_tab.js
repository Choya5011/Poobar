 ...
 * With the addition of ignore list to initTabs & some other minor modifications
 * Export to Poobar Main Panel script
*/

ppt.bgShow = new _p('_TAB_DISPLAY: Show Wallpaper', true);
ppt.bgBlur = new _p('_TAB_DISPLAY: Wallpaper Blurred', false);
ppt.bgMode = new _p('_TAB_DISPLAY: Wallpaper Mode', false);
ppt.col_mode = new _p('_TAB_PROPERTY: Color Mode (1,2,3)', 1);
ppt.orientation = new _p('_TAB_DISPLAY: Tab Orientation', false);
ppt.fontMode = new _p ('_TAB_DISPLAY: Switch  Icon or Text Font', false);
ppt.bgPath = new _p('_TAB_PROPERTY: Default Wallpaper Path', "path\\to\\custom\\image");
